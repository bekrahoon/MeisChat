...
def change_login(request: HttpRequest) -> HttpResponse:
...
def suspended_view(request: HttpRequest) -> HttpResponse:
    return render(
        request,
        "base/suspended.html",
        {
...
def participants(request: HttpRequest, pk: int) -> HttpResponse:
...
class UserProfileView(View):
    ...
    def get_user(self, pk: int) -> MyUser:
